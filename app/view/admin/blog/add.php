                    ...
                    <div class="app-card-body">
                        <form class="settings-form" action="<?php echo _WEB_ROOT ?>/admin/blog/handle_add" method="post" enctype="multipart/form-data">
                            <div class="mb-3 form-floating">
                                <input type="text" class="form-control" name="title" id="title" placeholder="Tên sản phẩm" value="<?php echo old_data('title', '') ?>">
                                <label for="title" class="form-label">Tiêu đề</label>
                                <?php echo form_error('title', '<span style="color:red;">', '</span>'); ?>
                            </div>
                            <div class="mb-3 form-floating">
                                <input type="text" class="form-control" name="meta" id="meta" placeholder="Thẻ meta" value="<?php echo old_data('meta', '') ?>">
                                <label for="meta" class="form-label">Thẻ meta</label>
                                <?php echo form_error('meta', '<span style="color:red;">', '</span>'); ?>
                            </div>
                            <div class="mb-3 form-floating">
                                <input type="text" class="form-control" name="author" id="author" placeholder="Tác giả" value="<?php echo old_data('author', '') ?>">
                            ...
                            <div class="mb-3 row">
                                <div class="col-md-8">
                                    <input type="file" name="img" class="form-control" id="img" accept="image/*" onchange="previewImage(this, 'preview')">
                                </div>
                                <div class="col-md-4">
                                    <img id="preview" src="#" alt="Preview Image" style="width: 100px; height: 100px; display: none;">
                                </div>
