<div class="app-content pt-3 p-md-3 p-lg-4">
	<div class="container-xl">
		<h1 class="app-page-title">Cài đặt</h1>
		<hr class="mb-4">
		<div class="row g-4 settings-section">
			<div class="col-12 col-md-4">
				<h3 class="section-title">Công ty</h3>
				<div class="section-intro">Phần cài đặt website của công ty là bước quan trọng đối với việc xây dựng một giao diện trực tuyến chuyên nghiệp và hiệu quả. Đội ngũ chuyên gia IT của chúng tôi chịu trách nhiệm thực hiện quy trình cài đặt này, bắt đầu từ việc lựa chọn nền tảng phù hợp nhất với mục tiêu kinh doanh của khách hàng.</div>
				<br>
			...
			<div class="col-12 col-md-8">
				<div class="app-card app-card-settings shadow-sm p-4">
					...
					<div class="app-card-body">
						<form class="settings-form" action="<?php echo _WEB_ROOT ?>/admin/setting/handle_infor" method="post">
							<div class="mb-3">
								<label for="setting-input-1" class="form-label">Tên công ty<span class="ms-2" data-bs-container="body" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-placement="top" data-bs-content="This is a Bootstrap popover example. You can use popover to provide extra info."><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-info-circle" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
											<path fill-rule="evenodd" d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
											<path d="M8.93 6.588l-2.29.287-.082.38.45.083c.294.07.352.176.288.469l-.738 3.468c-.194.897.105 1.319.808 1.319.545 0 1.178-.252 1.465-.598l.088-.416c-.2.176-.492.246-.686.246-.275 0-.375-.193-.304-.533L8.93 6.588z" />
											<circle cx="8" cy="4.5" r="1" />
										</svg></span></label>
								<br>
								<?php echo form_error('business_name', '<span style="color:red;">', '</span>'); ?>

								<input type="text" class="form-control" name="business_name" id="setting-input-1" value="<?php echo $business_name ?>">

							</div>
							<div class="mb-3">
								<label for="setting-input-2" class="form-label">Địa chỉ</label>
								<br>
								<?php echo form_error('address', '<span style="color:red;">', '</span>'); ?>

								<textarea style="height: 80px;" type="text" class="form-control" id="setting-input-2" name="address" placeholder="Địa chỉ..."><?php echo trim($address) ?></textarea>
							</div>
							<div class="mb-3">
								<label for="setting-input-3" class="form-label">Email công ty</label>
								<br>
								<?php echo form_error('email', '<span style="color:red;">', '</span>'); ?>

								<input type="text" class="form-control" id="setting-input-3" name="email" value="<?php echo $email ?>">
							</div>
							<div class="mb-3">
								<label for="setting-input-3" class="form-label">Số điện thoại công ty</label>
								<br>
								<?php echo form_error('phone', '<span style="color:red;">', '</span>'); ?>

								<input type="text" class="form-control" id="setting-input-3" name="phone" value="<?php echo $phone ?>">
							</div>
