                        ...
                        ?>
                                <div class="col-xl-4 col-md-6 col-12 mb-6">
                                    ...
                                    <div class="blog-list blog-grid-single-item blog-color--golden" data-aos="fade-up" data-aos-delay="0">
                                        <div class="image-box">
                                            <a href="<?php echo _WEB_ROOT . '/blogs/detail?id=' . $item['id'] . '&&title=' . $item['url'] ?>" class="image-link">
                                                <img class="img-fluid" style="height: 300px;" src="<?php echo _WEB_ROOT . $item['img'] ?>" alt="">
                                            </a>
                                        </div>
                                        <div class="content">
                                            <ul class="post-meta">
                                            ...
                                            <h6 class="title"><a href="<?php echo _WEB_ROOT . '/blogs/detail?id=' . $item['id'] . '&&title=' . $item['url'] ?>">{{$item['title']}}</a>
                                            </h6>
                                            ...
                                            <a href="<?php echo _WEB_ROOT . '/blogs/detail?id=' . $item['id'] . '&&title=' . $item['url'] ?>" class="read-more-btn icon-space-left">Đọc thêm<span class="icon"><i class="ion-ios-arrow-thin-right"></i></span></a>
                                        </div>
                                    </div>
